...
from .mdp.terrain_cfg import MY_ROUGH_TERRAINS_CFG
...
class MySceneCfg(InteractiveSceneCfg):
    ...
    # Height scanner
    # TODO: Update prim_path to your robot's base body link.
    #   ANYMAL C : "{ENV_REGEX_NS}/Robot/base"
...
class RewardsCfg:
    ...
    # -- base height (uses height scanner for accurate measurement on terrain)
    # TODO: Update target_height to match your robot's nominal stance height.
...
@configclass
class MyTerrainEnvCfg(ManagerBasedRLEnvCfg):
